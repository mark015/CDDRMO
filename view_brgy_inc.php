  ...
  <div class="content-wrapper">
    ...
    <div class="card-body" style="text-align:ceter;">
      ...
      ?>
        ...
        <img src="dist/img/<?php echo $img[$i];?>" class="imm"  alt="img" style="width:100%">
...
<div class="card col d-flex justify-content-center">
    <div class="card-body" style="text-align:left; font-family:currier new; ">
     ...
     <h2 class="">Date: <b><?php echo " " .$data['date']. " " . $data['time'];?></b></h2>
     <h2 class="">Reported By: <b><?php echo " " .$data['report_by'];?></b></h2>
     <h2 class="">Incident Reported By: <b><?php echo " " .$data['inc_report_by'];?></b></h2>
